...
//Binding object instance with access to the views in the activity_main.xml layout.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Setup a key listener on the EditText field to listen for "Enter" button presses
    ...
    /**
     * Calculates tip based on the user input.
     */
    private fun calculateTip() {
        ...
        //If the cost is 0 or nul, then display 0 tip and exit this function early
        if (cost == null || cost == 0.0) {
            displayTip(0.0)
            return
        }

        //Get tip percentage based on which radio button is selected
        ...
        //If the switch for rounding up the tip toggled on (isChecked is true), then round up
        // the tip. Otherwise do not change the tip value.
